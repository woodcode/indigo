...
func NewAppConfig() *AppConfig {
	return &AppConfig{config.NewDefault(), ""}
}

func LoadConfig(confName string) (*AppConfig, error) {
	var err error
...
func (c *AppConfig) Raw() *config.Config {
	return c.config
}

func (c *AppConfig) SetSection(section string) {
	c.section = section
}

func (c *AppConfig) SetOption(name, value string) {
	c.config.AddOption(c.section, name, value)
}

func (c *AppConfig) Int(option string) (result int, found bool) {
...
func (c *AppConfig) Bool(option string) (result, found bool) {
...
func (c *AppConfig) BoolDefault(option string, dfault bool) bool {
...
func (c *AppConfig) String(option string) (result string, found bool) {
...
func (c *AppConfig) HasSection(section string) bool {
...
func (c *AppConfig) Options(prefix string) []string {
	var options []string
